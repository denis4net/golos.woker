...
protected:
  ...
  {
    withdraw(proposal.budget, memo);
    proposal.budget = ZERO_ASSET;
  }
...
public:
  ...
  /// @abi action
  void reviewework(proposal_id_t proposal_id, account_name reviewer, uint8_t status, comment_id_t comment_id, const comment_data_t &comment)
  {
